...
           // String password=args[1];
		...
		String hosts[]={"va10puvfns001b","mom9puvwbs032","mom9puvwbs304","mom9puvwbs305","mom9puvwbs031","va10puvfns003","va10puvorc004","va10puvorc005",
				...
				"va10puvwbs022","va10puvwbs026","va10puvwbs027","vaathmr463","vaathmr466","va10puvwbs322","va10plvwbs604",
		...
		//String hosts[]={"dc04puvwbs300","dc04puvwbs301","dc04puvwbs304","dc04puvwbs305","dc04puvwbs306"};
						...
						for(int ind=1;ind<strArr.length+1;ind++)
						{
							...
							for(int ind1=0;ind1<newstr.length;ind1++)
							{
								if(newstr[ind1].contains("%"))
								{
									...
									if(((ind1%3==0)&&(ind1/3==1)&&Integer.valueOf(substrr)>75&&Integer.valueOf(substrr)!=100))
									{
		...
		{ 
			...
			message.setSubject("Disk Space check-Production Servers"); 

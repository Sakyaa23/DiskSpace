...
String hosts[]={"va10puvwbs300","dc04puvfns302","va10puvwbs033b"};
		 */
				...
				for(int i=0;i<resultUnix.size();i++) {
					...
					for (int j=0;j<str.length;j++) {
						...
						if(everyData.contains("%")) {
							...
							if((j%3==0) && (j/3==1) && !(rs.contains(str[6])) && Integer.valueOf(substrr)>75
		...
		{ 
			...
			message.setSubject("Disk Space check-Production Servers - "+strDate); 
	...
	private static List<String> unixSSH(String host, String cmd) throws JSchException, IOException{
		...
		//String pwd = "zbkKLvYZvUd86UHB#8-x";


		String user = "srcfnprdauto";
		String pwd = "W7zGy3YZqLj-qr-SI8dBhQNXQ";
		//String pwd = "msh!NhjX2fcDrN2F1Djt86-Uj";
